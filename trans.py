...
TOKEN = os.environ.get("TOKEN", "5091824724:AAEbQcXrEoqwNVplUjoJufKu2lGJ3_Qm_Rc")

API_ID = int(os.environ.get("API_ID", 18153722))

API_HASH = os.environ.get("API_HASH", "c00c2ffcf5c89ac76c524bf2c54828d4")
app = Client(
        "Gtt",
...
async def start(client, message):
    await message.reply_text(text =f"Привет **{message.from_user.first_name }** \n\nВведи текст на любом языке, который хочешь перевести\nПосле ввода, выбери язык",reply_to_message_id = message.message_id ,parse_mode="markdown",   reply_markup=InlineKeyboardMarkup([        [          InlineKeyboardButton("🔥 РЕКЛАМА 🔥" ,url="https://yandex.ru") ],    [ InlineKeyboardButton("🔥 РЕКЛАМА 🔥" ,url="https://fontanka.ru") ],          [InlineKeyboardButton("🌦 ПОГОДА ОНЛАЙН 🌦", url="https://t.me/dimaspogodabot") ]   ]  ) )
...
async def echo(client, message):
 ...
 keybord1= InlineKeyboardMarkup( [
        ...
        [   InlineKeyboardButton("🇫🇷 French",callback_data = "fr"),
            ...
            InlineKeyboardButton("🇮🇱 Hebrew",callback_data = "yi"),        
        ],
        [
            InlineKeyboardButton("🔥 РЕКЛАМА 🔥", url="https://yandex.ru")
        ],
        [
            InlineKeyboardButton("🔥 РЕКЛАМА 🔥" ,url="https://fontanka.ru")
        ],    
        [   
            InlineKeyboardButton("🌦 ПОГОДА ОНЛАЙН 🌦", url="https://t.me/dimaspogodabot")
        ],
    ] )
